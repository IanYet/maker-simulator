...
const GameMenuPage = lazy(() =>
	import('../ui/pages/GameMenuPage').then(({ GameMenuPage }) => ({ default: GameMenuPage })),
)
const NewGamePage = lazy(() =>
	import('../ui/pages/NewGamePage').then(({ NewGamePage }) => ({ default: NewGamePage })),
)
const SavesPage = lazy(() =>
	import('../ui/pages/SavesPage').then(({ SavesPage }) => ({ default: SavesPage })),
)
const PlayPage = lazy(() =>
	import('../ui/pages/PlayPage').then(({ PlayPage }) => ({ default: PlayPage })),
)
const ResultPage = lazy(() =>
	import('../ui/pages/ResultPage').then(({ ResultPage }) => ({ default: ResultPage })),
)
