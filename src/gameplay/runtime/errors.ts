import { SaveValidationError } from '../persistence/validation'
import type { CommandErrorCode, CommandResult } from '../types/game'
...
export function runtimeFailureResult(failure: RuntimeFailure, revision: number): CommandResult {
	return {
		ok: false,
