- [x] 读取所有 docs/game-design 下的文档与 types 下的类型声明，检查文档之间以及文档与类型定义之间的设计缺口和不一致，并完成设计一致性审计。
...
- [x] 编写readme.md：这是一个*网状叙事的事件驱动的构建 roguelike 游戏*类型游戏脚本的模拟运行环境，主要用来玩法验证，目前以实现viewer，计划实现 1.可视化编辑器，2.接入ai的游戏脚本生成agent app。还有其他你认为需要补充进的内容
